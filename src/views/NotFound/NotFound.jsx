...
export default function NotFound() {
  return (
    <>
      <main>
        <section className="d-flex min-vh-100 w-100 flex-column align-items-center justify-content-center pt-5">
          <div className="d-flex w-100 flex-column align-items-center justify-content-center text-center px-lg-2">
            <p className="display-1 fw-bold">404</p>
            <p className="display-3 fw-bold">Page Not Found</p>
            ...
            <Link
              to="/"
              className="d-flex align-items-center gap-2 btn btn-primary text-white"
              title="Return Home"
            >
          ...
          <div className="d-flex w-50 justify-content-center p-4 align-items-end">
            <svg
